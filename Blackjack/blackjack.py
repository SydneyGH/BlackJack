...
def deal_card(frame):
    ...
    #and add it to the back of the deck
    deck.append(next_card)
    # add the image to a Label and display the label
    tkinter.Label(frame, image=next_card[1], relief='raised').pack(side='left')
    # now we return the card face value
    return next_card


def score_hand(hand):
    # Calculate the total socre of all card in the list.
...
restart_button = tkinter.Button(button_frame, text="New game", command=new_game)
